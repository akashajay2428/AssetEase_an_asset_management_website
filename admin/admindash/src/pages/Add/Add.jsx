        ...
        <form onSubmit={onsubmitHandler} action="" className="flex-col">
          ...
          <div className="add-category-price">
            <div className="add-category-price flex-col">
              ...
              <select
                name="category"
                value={data.category} // Ensure the selected value reflects the state
                onChange={onChangeHandler} // Update the state when the value changes
              >
                <option value="Comonly used">Commonly Used</option>
